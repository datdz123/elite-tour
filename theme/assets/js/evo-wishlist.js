				...
				Bizweb.getProduct(productHandle,function(product){
					...
					for (i = 0; i < tag.length; i++){
						if(tag[i].includes("oto")){
										   tourTransport += '<li title="'+tag[i].split("_")[1]+'"><img src="//bizweb.dktcdn.net/100/562/154/themes/1004558/assets/tag_icon_1.svg?1768793099514" alt="'+tag[i].split("_")[1]+'"></li>';		
						   }
						   if(tag[i].includes("tauthuy")){
						   tourTransport += '<li title="'+tag[i].split("_")[1]+'"><img src="//bizweb.dktcdn.net/100/562/154/themes/1004558/assets/tag_icon_2.svg?1768793099514" alt="'+tag[i].split("_")[1]+'"></li>';		
					}
					if(tag[i].includes("maybay")){
									   tourTransport += '<li title="'+tag[i].split("_")[1]+'"><img src="//bizweb.dktcdn.net/100/562/154/themes/1004558/assets/tag_icon_3.svg?1768793099514" alt="'+tag[i].split("_")[1]+'"></li>';		
					   }
					   if(tag[i].includes("khoihanh")){
									   tourTagDate += '<li class="clearfix"><img src="//bizweb.dktcdn.net/100/562/154/themes/1004558/assets/tag_icon_4.svg?1768793099514" alt="'+tag[i].split("_")[1]+'">Lịch khởi hành: <span>'+tag[i].split("_")[1]+'</span></li>';		
					   }
					   if(tag[i].includes("thoigian")){
									   tourTagDate += '<li class="clearfix"><img src="//bizweb.dktcdn.net/100/562/154/themes/1004558/assets/tag_icon_5.svg?1768793099514" alt="'+tag[i].split("_")[1]+'">Thời gian: <span>'+tag[i].split("_")[1]+'</span></li>';		
					   }
					   }
