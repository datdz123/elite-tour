!function(a) {
    ...
    a.fn.prettyPhoto = function(f) {
        ...
        function q(b) {
            ...
            isSet && settings.overlay_gallery) {
                ...
                for (var c = 0; c < pp_images.length; c++)
                    pp_images[c].match(/\b(jpg|jpeg|png|gif)\b/gi) ? (classname = "",
                    img_src = pp_images[c]) : (classname = "default",
                    img_src = ""),
        ...
        a.prettyPhoto.initialize = function() {
            ...
            pp_titles = isSet ? jQuery.map(y, function(b, c) {
            ...
            pp_descriptions = isSet ? jQuery.map(y, function(b, c) {
